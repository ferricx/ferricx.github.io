...
export const PHONE_COUNTRIES: readonly { name: string; dialCode: string }[] = [
  ...
  { name: 'British Virgin Islands', dialCode: '+1284' },
  ...
  { name: 'Cayman Islands', dialCode: '+1345' },
  ...
  { name: 'Dem. Rep. of the Congo', dialCode: '+243' },
  ...
  { name: 'Northern Mariana Islands', dialCode: '+1670' },
  ...
  { name: 'Turks and Caicos Islands', dialCode: '+1649' },
